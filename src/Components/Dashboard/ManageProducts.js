...
const ManageProducts = () => {
        ...
        fetch(url, {
            ...
            .then(result => {
                if (result.success) {
                    ...
                    fetch('https://murmuring-fortress-98073.herokuapp.com/productsadd', {
                        method: 'post',
                        headers: {
    ...
    useEffect(() => {
        ...
        const url = `https://murmuring-fortress-98073.herokuapp.com/allproducts`
    ...
    const handleDelete = (id) => {
        ...
        if (proceed) {
            const url = `https://murmuring-fortress-98073.herokuapp.com/deleteproduct/${id}`
            fetch(url, {
                method: 'DELETE'
            })
                .then(res => res.json)
